...
def polygonFromPng(adress,sx,sy,ceil,minlen,maxlen):
    ...
    return (points,(polyall,ppxs,ppys))
...
def polygonify_all_outfits(pngPath, polyPath):
...
def polygonify_all_ships(pngPath, polyPath):
...
if __name__ == "__main__":
    ...
    polygonify_all_outfits( '../naev/dat/gfx/outfit/space/', '../naev/dat/gfx/outfit/space_polygon/' )
    polygonify_all_ships( '../naev/dat/gfx/ship/', '../naev/dat/gfx/ship_polygon/' )
    
    # Use the above stuff to generate only one ship or outfit polygon :
    
    #pntNplg = polygonFromPng('../naev/dat/gfx/ship/schroedinger/schroedinger.png',8,8,150,3,6)
    ...
    #plt.scatter(points[0][30],points[1][30])
    #plt.scatter(polygon[1][30],polygon[2][30])
